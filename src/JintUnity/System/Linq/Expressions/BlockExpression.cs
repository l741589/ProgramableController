...
namespace JintUnity.SystemCompat.Linq.Expressions {
    ...
    public class BlockExpression : Expression {
        ...
        public BlockExpression(Type type) :base((ExpressionType)47, type) { 
        }
/*
        /// <summary>
...
*/
    ...
    internal sealed class Block2 : BlockExpression {
        ...
        internal Block2(Expression arg0, Expression arg1) : base(arg1.Type) {
            _arg0 = arg0;
            _arg1 = arg1;
        }
    ...
    internal sealed class Block3 : BlockExpression {
        ...
        internal Block3(Expression arg0, Expression arg1, Expression arg2) :base(arg2.Type){
            _arg0 = arg0;
            _arg1 = arg1;
            _arg2 = arg2;
        }
    ...
    internal sealed class Block4 : BlockExpression {
        ...
        internal Block4(Expression arg0, Expression arg1, Expression arg2, Expression arg3) :base(arg3.Type){
            _arg0 = arg0;
            _arg1 = arg1;
            _arg2 = arg2;
            _arg3 = arg3;
    ...
    internal sealed class Block5 : BlockExpression {
        ...
        internal Block5(Expression arg0, Expression arg1, Expression arg2, Expression arg3, Expression arg4) :base(arg4.Type){
            _arg0 = arg0;
            _arg1 = arg1;
            _arg2 = arg2;
            _arg3 = arg3;
    ...
    internal class BlockN : BlockExpression {
        ...
        internal BlockN(IList<Expression> expressions) :base(expressions[expressions.Count-1].Type){
        ...
        internal override ReadOnlyCollection<Expression> GetOrMakeExpressions() {
            return ExpressionEx.ReturnReadOnly(ref _expressions);
        }
    ...
    internal class ScopeExpression : BlockExpression {
        ...
        internal ScopeExpression(IList<ParameterExpression> variables, Type type) : base(type){
    ...
    internal class ScopeN : ScopeExpression {
        ...
        internal ScopeN(IList<ParameterExpression> variables, IList<Expression> body)
            : base(variables,body[body.Count-1].Type) {
            _body = body;
        }

        internal ScopeN(IList<ParameterExpression> variables, IList<Expression> body, Type type)
            : base(variables, type) {
            _body = body;
        }
    ...
    internal class ScopeWithType : ScopeN {
        ...
        internal ScopeWithType(IList<ParameterExpression> variables, IList<Expression> expressions, Type type)
            : base(variables, expressions, type) {
            _type = type;
        }
    ...
    public partial class ExpressionEx {
        ...
        public static BlockExpression Block(params Expression[] expressions) {
            Utils.RequiresNotNull(expressions, "expressions");
            ...
            switch (expressions.Length) {
                ...
                default:
                    Utils.RequiresNotEmpty(expressions, "expressions");
                    RequiresCanRead(expressions, "expressions");
                    return new BlockN(expressions.Select(e=>e).ToArray());
            }
        }
        ...
        public static BlockExpression Block(IEnumerable<ParameterExpression> variables, IEnumerable<Expression> expressions) {
            Utils.RequiresNotNull(expressions, "expressions");
            var expressionList = new ReadOnlyCollection<Expression>(expressions.ToList());
            Utils.RequiresNotEmpty(expressionList, "expressions");
        ...
        public static BlockExpression Block(Type type, IEnumerable<ParameterExpression> variables, IEnumerable<Expression> expressions) {
            Utils.RequiresNotNull(type, "type");
            Utils.RequiresNotNull(expressions, "expressions");

            var expressionList = new ReadOnlyCollection<Expression>(expressions.ToList());
            var variableList = new ReadOnlyCollection<ParameterExpression>(variables.ToList());
            ...
            if (type != typeof(void)) {
                if (!Utils.AreReferenceAssignable(type, last.Type)) {
                    throw new Exception("ArgumentTypesMustMatch()");
                }
            }

            if (!Utils.AreEquivalent(type, last.Type)) {
