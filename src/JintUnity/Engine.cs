...
using JintUnity.Runtime.Jint.Runtime;
...
namespace JintUnity
{
    public class Engine
    {
        ...
        internal static Dictionary<Type, Func<Engine, object, JsValue>> TypeMappers = new Dictionary<Type, Func<Engine, object, JsValue>>()
        {
            ...
            { typeof(Regex), (Engine engine, object v) => engine.RegExp.Construct(((Regex)v).ToString().Trim('/')) }
        };
