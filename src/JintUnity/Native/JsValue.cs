...
using JintUnity.Native.Boolean;
using JintUnity.Native.Date;
using JintUnity.Native.Function;
using JintUnity.Native.Number;
using JintUnity.Native.Object;
using JintUnity.Native.RegExp;
using JintUnity.Native.String;
...
namespace JintUnity.Native
{
    ...
    public class JsValue : IEquatable<JsValue>
    {
        ...
        public object ToObject() {
            return ToObject(new Dictionary<JsValue, object>());
        }

        private object ToObject(Dictionary<JsValue,object> references)
        {
            switch (_type)
            {
                case Types.None:
                ...
                case Types.Object:
                    ...
                    switch ((_object as ObjectInstance).Class)
                    {
                        case "Array":
                            object r;
                            if (references.TryGetValue(this, out r)) {
                                return r;
                            }
                            ...
                            if (arrayInstance != null)
                            {
                                ...
                                for (var k = 0; k < len; k++)
                                {
                                    ...
                                    if (kpresent)
                                    {
                                        ...
                                        result[k] = kvalue.ToObject(references);
                                    }
                                    else
                                    {
                                        result[k] = null;
                        ...
                        case "Object":
                            ...
                            if (references.TryGetValue(this, out r)) {
                                ...
                                references[this] = o = new Dictionary<string, object>();
                            }
                            ...
                            foreach (var p in (_object as ObjectInstance).GetOwnProperties())
                            {
                                ...
                                o.Add(p.Key, (_object as ObjectInstance).Get(p.Key).ToObject(references));
                            }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case Types.Null:
                    return "null";
                case Types.Boolean:
                    return _double != 0 ? bool.TrueString.ToLower() : bool.FalseString.ToLower();
                case Types.Number:
