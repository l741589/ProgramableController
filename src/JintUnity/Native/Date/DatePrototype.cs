...
namespace JintUnity.Native.Date
{
    /// <summary>
    ...
    public sealed class DatePrototype : DateInstance
    {
        ...
        public double LocalTza
        {
            get
            {
                return Engine.Options._LocalTimeZone.GetUtcOffset(DateTime.Now).TotalMilliseconds;
            }
        }
        ...
        public DateTime ToLocalTime(DateTime t)
        {
            switch (t.Kind)
            {
                case DateTimeKind.Local:
                    return t.ToUniversalTime().ToLocalTime();
                    //return Engine.Options._LocalTimeZone.GetUtcOffset(t.ToUniversalTime());
